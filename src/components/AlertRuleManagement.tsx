...
export const AlertRuleManagement: React.FC<AlertRuleManagementProps> = ({ alertRules, setAlertRules }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (editingRule) {
      setAlertRules(alertRules.map(r => r.id === editingRule.id ? newRule : r));
    } else {
  ...
  const handleAIGenerate = async () => {
    ...
    try {
      ...
      setFormData({
        ...formData,
        alert: response.alert || 'GeneratedAlert',
          ...
          <div key={rule.id} className="bg-gray-800 rounded-xl p-6 border border-gray-700 hover:border-gray-600 transition-colors">
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-white">{rule.alert}</h3>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="text-gray-300">Duration: {rule.for}</span>
              </div>
